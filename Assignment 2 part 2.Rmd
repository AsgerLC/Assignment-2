...
#write.csv(cleaned_train, "Cleaned Training Data.csv")
...
#write.csv(cleaned_test, "Cleaned Test Data.csv")


##- Loading the already cleaned data
cleaned_train <- read.csv("Cleaned Training Data.csv")
cleaned_test <- read.csv("Cleaned Test Data.csv")
# Cleaning test data of NA's:
cleaned_test <- subset(cleaned_test, !is.na(CHI_MLU))

#- recreate the models you chose last time (just write the code again and apply it to Train Data)
trained_model <- lmerTest::lmer(CHI_MLU ~ Visit*Diagnosis + verbalIQ1 + MOT_MLU + (1|Child.ID) + (0 + Visit|Child.ID), data = cleaned_train)
...
####I suppose I could do more here!
...
#As a rule, when I run this, the effects of various k-folding schemes on the RMSE are present, but often pretty small, especially as fold nr gets higher.
...
absol_dist <-mean(bernie$CHI_MLU) - TD_vst_avr$avr_MLU
