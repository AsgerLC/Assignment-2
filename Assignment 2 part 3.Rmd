...
int_sim = powerSim(fav, fixed("Visit:Diagnosis"), nsim = 1000, seed = 1, progress = F) 
int_sim # Power of 100%! Of course, this is an observed power calculations.

# And now for verbal IQ at visit 1
vIQsim = powerSim(fav, fixed("verbalIQ1"), nsim = 1000, seed = 1, progress = F)
vIQsim #100% power!

# Mother's MLU
momsim = powerSim(fav, fixed("MOT_MLU"), nsim = 1000, seed = 1, progress = F)
momsim #100% Power!
...
int_curve = powerCurve(fav_extend, fixed("Visit:Diagnosis"), along = "Child.ID", nsim = 500, breaks = seq(from = 10, to = 120, by = 5), seed = 1, progress = F)
...
mom_curve = powerCurve(fav_extend, fixed("MOT_MLU"), along = "Child.ID", nsim = 500, breaks = seq(from = 10, to = 120, by = 5), seed = 1, progress = F)
...
IQ_curve = powerCurve(fav_extend, fixed("verbalIQ1"), along = "Child.ID", nsim = 500, breaks = seq(from = 10, to = 120, by = 5), seed = 1, progress = F)
...
int_sim2 = powerSim(fav, fixed("Visit:Diagnosis"), nsim = 1000, seed = 1, progress = F) 
...
int_sim3 = powerSim(fav, fixed("Visit:Diagnosis"), nsim = 1000, seed = 1, progress = F) 
...
int_curve2 = powerCurve(fav_extend, fixed("Visit:Diagnosis"), along = "Child.ID", nsim = 500, breaks = seq(from = 10, to = 120, by = 5), seed = 1, progress = F)
...
vIQsim2 = powerSim(fav, fixed("verbalIQ1"), nsim = 1000, seed = 1, progress = F)
vIQsim2 #100% power!


# We make the power curve and plot it
IQ_curve2 = powerCurve(fav, fixed("verbalIQ1"), along = "Child.ID", nsim = 500, breaks = seq(from = 10, to = 120, by = 5), seed = 1, progress = F)
plot(IQ_curve2)
IQ_curve2
...
momsim2 = powerSim(fav, fixed("MOT_MLU"), nsim = 1000, seed = 1, progress = F)
momsim2 #80% Power! [Probably needs more sims]

# We make the power curve and plot it
mom_curve2 = powerCurve(fav, fixed("MOT_MLU"), along = "Child.ID", nsim = 500, breaks = seq(from = 10, to = 120, by = 5), seed = 1, progress = F)
plot(mom_curve2)
mom_curve2
...
# plot the powercurve
mom_curve3 = powerCurve(fav_extend150, fixed("MOT_MLU"), along = "Child.ID", nsim = 500, breaks = seq(from = 10, to = 150, by = 5), seed = 1, progress = F)
mom_curve3
...
int_30_curve = powerCurve(fav, fixed("Visit:Diagnosis"), along = "Child.ID", nsim = 500, breaks = seq(from = 3, to = 30, by = 3), seed = 1, progress = F)
...
vIQ_30_curve = powerCurve(fav, fixed("verbalIQ1"), along = "Child.ID", nsim = 500, breaks = seq(from = 3, to = 30, by = 3), seed = 1, progress = F)
vIQ_30_curve
plot(vIQ_30_curve)
...
mom_30_curve = powerCurve(fav, fixed("MOT_MLU"), along = "Child.ID", nsim = 500, breaks = seq(from = 3, to = 30, by = 3), seed = 1, progress = F)
mom_30_curve
plot(mom_30_curve)
